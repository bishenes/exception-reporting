...
const API_KEY = '962f9e49e7f9485db2a4707dc7dbaeb5'
...
export default class Reporter {
  ...
  addPackageMetadata (error) {
    ...
    if (activePackages.length > 0) {
      ...
      //fix bugsnag#5b38ad0ac3e3e9001821dd68 Cannot set property 'bundledPackages' of undefined
      if (error.metadata == undefined) { error.metadata = {} }
